// A configuration without X.509 and TLS support
// This file was edited by Keziah Biermann
 ...
 */
// HACK: Needed because Windows fails if `mbedtls_ssl_premaster_secret` has no fields
 ...
 *
 */
// HACK: Required for windows builds
